...
def main(c,t,lf,lw,ht,hb,alpha, n_foil, n_north, n_east, n_south, n_west, e_foil, e_north, e_east, e_south, e_west, dir_loc, user_name=None):
    dz = 0.05
    if dz > 0:
        dz = -1*dz
    if lf > 0:
    ...
    plt.savefig('{}/figure.png'.format(dir_loc))
...
if __name__ == '__main__':
    ...
    file = open("{}/system/blockMeshDict".format(dir_loc), 'w')
    file.write(output)